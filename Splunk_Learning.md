...
- [Splunk Zero to Power User Notes](#splunk-zero-to-power-user-notes)
- [Table of Contents](#table-of-contents)
  - [Module 1: Introduction](#module-1-introduction)
  - [Module 2: What Makes Up Splunk](#module-2-what-makes-up-splunk)
  - [Module 3: Setup \& Data Prep](#module-3-setup--data-prep)
    - [Required Add-ons (via Splunkbase)](#required-add-ons-via-splunkbase)
    - [Data Ingestion Mapping Summary](#data-ingestion-mapping-summary)
    - [Verification](#verification)
  - [Module 4: Data Ingestion \& Architecture](#module-4-data-ingestion--architecture)
    - [The Data Pipeline](#the-data-pipeline)
    - [Core Ingestion Metadata](#core-ingestion-metadata)
    - [Data Preview \& Inputs](#data-preview--inputs)
    - [Apps vs. Add-ons (Technology Add-ons / TAs)](#apps-vs-add-ons-technology-add-ons--tas)
  - [Module 5: Searching \& Navigation](#module-5-searching--navigation)
  - [Module 6: Knowledge Objects (KOs)](#module-6-knowledge-objects-kos)
    - [Definition \& Purpose](#definition--purpose)
    - [Management \& Naming Best Practices](#management--naming-best-practices)
    - [Permission Scopes](#permission-scopes)
    - [Demo Highlights](#demo-highlights)
  - [Module 7: Fields \& Field Discovery](#module-7-fields--field-discovery)
    - [Key Value Syntax \& Case Sensitivity](#key-value-syntax--case-sensitivity)
    - [Field Sidebar \& Identifiers](#field-sidebar--identifiers)
    - [Field Window Quick Reports](#field-window-quick-reports)
    - [`!=` vs. `NOT` Logic Behavior](#-vs-not-logic-behavior)
  - [Module 8: Search Processing Language (SPL)](#module-8-search-processing-language-spl)
    - [SPL Syntax Color Coding](#spl-syntax-color-coding)
    - [Search Optimization \& Execution Order](#search-optimization--execution-order)
    - [Core SPL Commands](#core-spl-commands)
  - [Module 9: Transforming Commands](#module-9-transforming-commands)
    - [Transforming Commands Overview](#transforming-commands-overview)
    - [Core Transforming Commands](#core-transforming-commands)
    - [Key `stats` Functions](#key-stats-functions)
    - [Table Formatting \& Visuals](#table-formatting--visuals)
  - [Module 10: Event Correlation \& Transactions](#module-10-event-correlation--transactions)
    - [The `transaction` Command](#the-transaction-command)
    - [Primary Command Arguments](#primary-command-arguments)
    - [Performance Considerations: `transaction` vs. `stats`](#performance-considerations-transaction-vs-stats)
  - [Module 11: Data Manipulation (`eval`, `where`, `search`)](#module-11-data-manipulation-eval-where-search)
    - [Data Filtering \& Field Creation Comparison](#data-filtering--field-creation-comparison)
    - [The `eval` Command \& Functions](#the-eval-command--functions)
    - [`where` vs. `search` Rules](#where-vs-search-rules)
  - [Module 12: Field Extracting](#module-12-field-extracting)
    - [Field Extraction Methods Overview](#field-extraction-methods-overview)
    - [Interactive Field Extractor (FX) Access Points](#interactive-field-extractor-fx-access-points)
    - [Inline Field Extraction Commands (`rex` vs. `erex`)](#inline-field-extraction-commands-rex-vs-erex)
  - [Module 13: Lookups](#module-13-lookups)
    - [Lookups Overview](#lookups-overview)
    - [Lookup Configuration Workflow](#lookup-configuration-workflow)
    - [Core Lookup Commands](#core-lookup-commands)
    - [`OUTPUT` vs. `OUTPUTNEW`](#output-vs-outputnew)
  - [Module 14: Data Visualization Fundamentals](#module-14-data-visualization-fundamentals)
    - [Overview of Visualization Types](#overview-of-visualization-types)
    - [Charting Commands Comparison (`stats` vs. `chart` vs. `timechart`)](#charting-commands-comparison-stats-vs-chart-vs-timechart)
    - [Key Command Arguments](#key-command-arguments)
    - [Panel Formatting Options](#panel-formatting-options)
  - [Module 15: Visualizations, Part 2!](#module-15-visualizations-part-2)
    - [Location \& Mapping Commands](#location--mapping-commands)
    - [Statistical \& Analytics Enhancement Commands](#statistical--analytics-enhancement-commands)
    - [Formatting \& Layout Enhancements](#formatting--layout-enhancements)
  - [Module 16: Reports \& Drilldowns](#module-16-reports--drilldowns)
    - [Reports Overview](#reports-overview)
    - [Dashboard Inputs \& Tokens](#dashboard-inputs--tokens)
    - [Drilldown Functionality](#drilldown-functionality)
    - [Home Dashboard Configuration](#home-dashboard-configuration)
  - [Module 17: Alerts](#module-17-alerts)
    - [Alerts Overview](#alerts-overview)
    - [Alert Execution \& Trigger Conditions](#alert-execution--trigger-conditions)
    - [Throttling \& Actions](#throttling--actions)
  - [Module 18: Welcome, Tags and Events!](#module-18-welcome-tags-and-events)
    ...
    - [Summary Comparison: Tags vs. Event Types](#summary-comparison-tags-vs-event-types)
  - [Module 19: Macros](#module-19-macros)
    - [Macros Overview \& Syntax](#macros-overview--syntax)
    - [Macro Arguments \& Naming Conventions](#macro-arguments--naming-conventions)
    - [Configuration Navigation](#configuration-navigation)
  - [Module 20: Workflows to Save You Time](#module-20-workflows-to-save-you-time)
    - [Workflow Actions Overview](#workflow-actions-overview)
    - [Key Configuration Parameters (`Settings > Fields > Workflow actions`)](#key-configuration-parameters-settings--fields--workflow-actions)
    - [Usage Context \& Best Practices](#usage-context--best-practices)
  - [Module 21: Data Normalization \& Troubleshooting](#module-21-data-normalization--troubleshooting)
    - [Field Aliases \& Data Normalization](#field-aliases--data-normalization)
    - [Calculated Fields](#calculated-fields)
    - [Index Bucket Lifecycle \& Storage](#index-bucket-lifecycle--storage)
    - [Troubleshooting \& Search Performance Tools](#troubleshooting--search-performance-tools)
  - [Module 22: Datamodels](#module-22-datamodels)
    - [Datamodels Overview \& Acceleration](#datamodels-overview--acceleration)
    - [Datamodel Structure](#datamodel-structure)
    - [Pivot Tool](#pivot-tool)
    - [Searching Datamodels via SPL](#searching-datamodels-via-spl)
    - [Key Differences: `stats` vs. `tstats`](#key-differences-stats-vs-tstats)
  - [Module 23: The Common Information Model (CIM)](#module-23-the-common-information-model-cim)
    - [Common Information Model Overview](#common-information-model-overview)
    - [Data Normalization \& CIM Mapping](#data-normalization--cim-mapping)
    - [Splunk Add-on Builder (TA Builder)](#splunk-add-on-builder-ta-builder)
